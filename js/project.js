...
function updateOverviewCellHeight() {
  ...
  if (window.innerWidth <= 991) {
    const availH = stableViewportHeight() - 88 - 101 - _safeAreaBottom; // below nav, above tab pill + safe area
...
function switchLayoutHandler(newLayout) {
  ...
  // Defer sizes update until after animation completes — changing sizes mid-animation
  // triggers a visible srcset swap in Safari and on real mobile devices.
