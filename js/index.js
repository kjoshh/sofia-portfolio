...
eraseCanvas.style.cssText = 'position:fixed;inset:0;z-index:10;pointer-events:none;cursor:none;';
...
// ── Cursor parallax (name follows mouse gently) ──
...
function erase(e) {
  ...
  ectx.lineTo(e.clientX, e.clientY);
  ectx.stroke();
  lastX = e.clientX;
  lastY = e.clientY;
}
